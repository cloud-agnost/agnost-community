...
export default function ConnectAWS() {
	...
	const { returnToPreviousStep, addExistingResource, toggleCreateResourceModal } =
		useResourceStore();
		...
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)}>
				<CreateResourceLayout
					title={t('resources.storage.aws.title')}
					actions={
						<>
							<Button type='button' variant='secondary' onClick={returnToPreviousStep}>
								{t('general.previous')}
							</Button>
