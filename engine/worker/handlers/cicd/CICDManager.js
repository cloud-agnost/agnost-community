...
export class CICDManager {
    ...
    async manageKnativeService({ container, environment, gitProvider, changes, action }) {
    ...
    async manageCronJob({ container, environment, gitProvider, changes, action }) {
        const name = container.iid;
        const namespace = environment.iid;
        if (action === "create") {
            try {
    ...
    async manageStatefulSet({ container, environment, gitProvider, changes, action }) {
        const name = container.iid;
        const namespace = environment.iid;
        if (action === "create") {
            try {
    ...
    async manageDeployment({ container, environment, gitProvider, changes, action }) {
        const name = container.iid;
        const namespace = environment.iid;
        if (action === "create") {
            try {
                    ...
                    case "Ingress":
                        ...
                        if (cluster) {
                            if (cluster.enforceSSLAccess) {
                                ...
                                resource.metadata.annotations["nginx.ingress.kubernetes.io/force-ssl-redirect"] =
                                    "true";
                            } else {
                                resource.metadata.annotations["nginx.ingress.kubernetes.io/ssl-redirect"] = "false";
                                resource.metadata.annotations["nginx.ingress.kubernetes.io/force-ssl-redirect"] =
                                    "false";
                            }
...
async function createGithubWebhook(gitPat, gitRepoUrl, webhookUrl, secretToken, sslVerification = false) {
...
async function createGitlabWebhook(gitPat, gitRepoUrl, webhookUrl, secretToken, gitBranch, sslVerification = false) {
    ...
    const responseProject = await fetch(`${gitlabApiBaseUrl}/users/${userId}/projects`, {
