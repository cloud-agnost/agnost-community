				...
				if (
					...
					if (
						...
						sendMessage(msgObj.env._id, {
							...
							description: t("Environment deletion timed out due to errors"),
							timestamp: Date.now(),
							data: msgObj,
							identifiers: {
									...
									logs: [
										{
											...
											status: "Error",
											message: "nvironment deletion timed out due to errors",
										},
									],
								},
								{
						...
						logger.info(
							t(
								"nvironment deletion timed out for app '%s' version '%s' environment '%s'",
								msgObj.app.name,
